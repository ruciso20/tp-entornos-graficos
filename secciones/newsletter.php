<!-- seccion Newsletter -->
<section class="py-5 bg-primary text-white" id="newsletter">
  <div class="container">
        ...
        <div class="newsletter-content">
          ...
          <?php if (isset($_SESSION['user_id'])): ?>
            ...
            <div class="alert alert-success mb-4">
              ...
              <strong>¡Ya estás suscrito!</strong> Como usuario registrado, recibirás automáticamente nuestras novedades.
            </div>
          ...
          <?php else: ?>
            ...
            <div class="alert alert-warning mb-4">
              ...
              <strong>Regístrate para recibir novedades</strong> Crea una cuenta y recibe promociones personalizadas según tu categoría
            </div>
            ...
            <div class="row mt-5">
              ...
              <div class="col-md-4">
                <div class="feature-item">
                  <i class="fas fa-calendar-star fa-2x text-warning mb-3"></i>
